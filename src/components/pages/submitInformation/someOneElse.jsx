...
import { postCreatePatient } from "../../../redux/patientSite/patientRegister/patientRegisterApi";
...
const SomeOneElse = () => {
  ...
  const submitFormik = useFormik({
    ...
    onSubmit: (values, onSubmitProps) => {
      dispatch(
        postCreatePatient({
          symptoms: submitFormik.values.symptoms,
          firstname: submitFormik.values.submitFirstName,
          lastname: submitFormik.values.submitLastName,
          date_of_birth: submitFormik.values.date,
          email: submitFormik.values.submitemail,
          mobile_no: submitFormik.values.submitPhoneNumber,
          street: submitFormik.values.street,
          city: submitFormik.values.city,
          state: submitFormik.values.state,
          zip: submitFormik.values.zipCode,
          room: submitFormik.values.room,
          relation_with_patient: submitFormik.values.relationWithSubmit,
        }),
      );
          ...
          <Container maxWidth="md" className="submit-main-wrapper">
            ...
            <Paper className="submit-main-paper">
              ...
              <Grid container spacing={{ xs: 1, md: 2 }} margin="2rem">
                <Grid item xs={12} md={6} lg={6}>
                  <FormInput
                    name="relationWithSubmit"
                    label="Relation with Patient (optional)"
                    fullWidth
                    value={submitFormik.values.relationWithSubmit}
                    onChange={submitFormik.handleChange}
                    onBlur={submitFormik.handleBlur}
                    error={
                      submitFormik.touched.relationWithSubmit &&
                      Boolean(submitFormik.errors.relationWithSubmit)
                    }
                    helperText={
                      submitFormik.touched.relationWithSubmit &&
                      submitFormik.errors.relationWithSubmit
                    }
                  />
                </Grid>
              </Grid>
